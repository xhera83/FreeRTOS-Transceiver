...
class FRTTransceiver
{
   ...
   public:
      ...
      ~FRTTransceiver();
      bool addCommPartner(FRTTransceiver_TaskHandle partnersAddress = NULL,FRTTransceiver_QueueHandle queueRX = NULL,
      ...
      bool readFromQueue(FRTTransceiver_TaskHandle partner,eMultiSenderQueue multiSenderQueue,bool bUseTaskHandleVar,int blockTime = 100,int blockTimeTakeSemaphore = 100);
      ...
      */
      ...
      /* Read received data         */
      const TempDataContainer * getNewestBufferedDataFrom(FRTTransceiver_TaskHandle partner,eMultiSenderQueue multiSenderQueue,bool bUseTaskHandleVar);
      const TempDataContainer * getOldestBufferedDataFrom(FRTTransceiver_TaskHandle partner,eMultiSenderQueue multiSenderQueue,bool bUseTaskHandleVar);
      const TempDataContainer * getBufferedDataFrom(FRTTransceiver_TaskHandle partner,eMultiSenderQueue multiSenderQueue,bool bUseTaskHandleVar,uint8_t u8PositionInBuffer);
      /* -----------------          */
